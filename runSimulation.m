function runSimulation(varargin)
   ...
   opt.default_formation = 'Johansenfm';
   ...
   opt.default_rate      = 1.4* mega * 1e3 / year / rhoCref; % default injection rate
   ...
   opt.inj_steps         = 10;
   opt.mig_time          = 2000 * year;
   opt.mig_steps         = 30;
   opt.well_radius       = 0.3;
   opt.C                 = 0.1;
   opt.subtrap_file      = 'Johansenfm_subtrap_function_3.mat';
